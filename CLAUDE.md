...
## 현재 상태 (2026-08-01 기준)
Phase A~C 로드맵 완료. 현재 Phase D (첫 20명 유료 고객 확보) — 마케팅 중심.

## 마케팅·제품 방향 (2026-08-01 확정)
- **니즈 우선**: 기능·성능 나열보다 고객 니즈를 예측·파악해 필요한 서비스로 만족감을 주는 것이 목표
- **변화를 그려주기**: 소상공인·PT·강사가 "쓰고 싶게" — 가격·기능은 당연한 전제, 쓰고 나서 달라지는 모습을 보여주는 메시지로
- **바이오링크 본연 + SEO**: 바이오링크 역할에 충실하면서 SEO를 잘 태우는 것이 핵심
- **스레드(Threads) 유입 중심**: 주 홍보 채널이 스레드 → 모바일 반응형 품질이 곧 전환율. UI/UX 개선의 최우선 기준은 모바일
