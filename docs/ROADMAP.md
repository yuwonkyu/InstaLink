...
- [x] Pro 평생 무료(is_mvp) 이벤트 종료 (2026-07-31) → 신규 가입 첫 달 Pro 무료 체험으로 전환 (`lib/trial.ts`, 2026-08-01)
...
```
3개월: 첫 유료 고객 5명
  Basic 3 × 4,900 + Pro 2 × 7,900 = 30,500원/월

6개월: 유료 고객 15명
  Basic 10 × 4,900 + Pro 5 × 7,900 = 88,500원/월

12개월: 유료 고객 30명
  Basic 18 × 4,900 + Pro 12 × 7,900 = 183,000원/월
```
